...
//////////////////////////////////////////////////////////////////////////////
	...
	highp vec3 worldpos = transform(bonetm, DT_POSITION) * w;
		...
		mediump vec3 worldtangent = rotate( mat3(bonetm), DT_TANGENT ) * w;
	#endif
...
//////////////////////////////////////////////////////////////////////////////
	...
	mediump vec3 worldbinormal = cross( normalize(V_Normal), worldtangent );
	mediump vec3 worldtangent = normalize(mat3(WORLDTM) * DT_TANGENT);
